        ...
        <div class="modal-content sp-modal">
            ...
            <form method="post" action="<?= site_url('auth/login') ?>" class="sp-modal-body">
                ...
                <?php if (!empty($errors['email'])): ?>
                    <div class="sp-err"><?= esc($errors['email']) ?></div>
                <?php endif; ?>
                ...
                <?php if (!empty($errors['password'])): ?>
                    <div class="sp-err"><?= esc($errors['password']) ?></div>
                <?php endif; ?>
                ...
                <div class="sp-minihelp">
                    Belum punya akun?
                    <button class="sp-link" type="button"
                        data-bs-dismiss="modal"
                        data-bs-toggle="modal"
                        data-bs-target="#modalRegister">Daftar</button>
                </div>
            </form>
        </div>
    </div>
